...
for (var i=1; i<7; i++) {
  ...
  while (isNaN(n) || n === null || (n - parseInt(n) != 0)){                                     //Imposto un ciclo while di controllo che impedisca al ciclo for di continuare nel caso in cui il valore inserito non sia un numero >= 0 intero
